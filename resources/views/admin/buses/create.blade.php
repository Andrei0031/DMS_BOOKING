...
$title = 'Add New Bus - ' . ucfirst($panel) . ' Panel';
...
<div class="bg-white rounded-xl border border-gray-100 p-6" style="max-width:720px;">
    ...
    <form method="POST" action="/DMS_BOOKING/<?php echo $panel; ?>/buses" style="display:grid;grid-template-columns:1fr 1fr;gap:18px;">
        <!-- Bus Number -->
